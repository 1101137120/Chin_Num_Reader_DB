...
namespace SMC5052B
{
    ...
    public LanguageData LanguageTCN()
    {
            ...
            LanguageData.TagIsDBS ="資料庫已擁有 ";
            LanguageData.TagIsDBF ="未查詢到此Tag";
            LanguageData.LoadDBTag = "讀取Tag模式";
            LanguageData.TextDBLoad = "輸入讀取";
            LanguageData.groupBox ="查詢Tag";
            return LanguageData;
    }
    ...
    public LanguageData LanguageSCN()
    {
            ...
            LanguageData.checkChinHeader = "提示";
            LanguageData.TagIsDBS = "资料库已拥有 ";
            LanguageData.TagIsDBF = "未查询到此Tag";
            LanguageData.LoadDBTag = "读取Tag模式";
            LanguageData.TextDBLoad = "输入读取";
            LanguageData.groupBox = "查询Tag";
            return LanguageData;
    }
        ...
        public LanguageData LanguageEN()
        {
            ...
            LanguageData.TagIsDBS = "Database already owned";
            LanguageData.TagIsDBF = "for querying this tag";
            LanguageData.LoadDBTag = "Read Tag Mode";
            LanguageData.TextDBLoad = "Input Read";
            LanguageData.groupBox = "Query Tag";
    ...
    public class LanguageData
    {
        ...
        public string TagIsDBS { get; set; }
        public string TagIsDBF { get; set; }
        public string LoadDBTag { get; set; }
        public string TextDBLoad { get; set; }
